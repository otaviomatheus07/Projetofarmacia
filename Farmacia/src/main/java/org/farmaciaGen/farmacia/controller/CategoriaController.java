...
@RequestMapping ("/categorias") // Define a requisição localhost
...
public class CategoriaController {
	...
	@GetMapping("/descricao/{descricao}") // Ira buscar tudo pela descricao
	...
	@PostMapping // Insere novos dados ao bancos de dados
	public ResponseEntity<Categoria> post(@Valid @RequestBody Categoria categoria){
		return ResponseEntity.status(HttpStatus.CREATED)
				.body(categoriaRepository.save(categoria));
	}
	@PutMapping // atualiza qualquer dado do banco
